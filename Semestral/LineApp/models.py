...
class Lineup (models.Model):
    ...
    mapa = models.CharField(max_length=30,blank=False,null=False,verbose_name="Precio")
    bando = models.IntegerField(blank=False,null=False,verbose_name="Tipo instrumento",choices=bando,default=-1)
